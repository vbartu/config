...
let s:darkgrey    = { "gui": "#282c34", "cterm": "236" }
let s:grey        = { "gui": "#595b5e", "cterm": "241" }
let s:lightgrey   = { "gui": "#9ca0a6", "cterm": "247" }

let s:fg          = s:white
let s:bg          = { "gui": "#18181c", "cterm": "236" }
"let s:bg          = { "gui": "#000000", "cterm": "236" }

let s:comment_fg  = { "gui": "#5c6370", "cterm": "241" }
let s:gutter_bg   = { "gui": "#282c34", "cterm": "236" }
let s:gutter_fg   = { "gui": "#919baa", "cterm": "247" }

let s:cursor_line = { "gui": "#34343d", "cterm": "237" }
...
call s:h("NonText", s:grey, "", "")

call s:h("Cursor", s:bg, s:darkgrey, "")
call s:h("CursorColumn", "", s:cursor_line, "")
call s:h("CursorLine", "", s:cursor_line, "")

call s:h("LineNr", s:lightgrey, "", "")
call s:h("CursorLineNr", s:yellow, "", "bold")
...
call s:h("ColorColumn", "", s:darkgrey, "")
